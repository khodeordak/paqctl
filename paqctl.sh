...
# ║                                                                   ║
# ║  Paqet: https://github.com/khodeordak/paqctl                       ║
# ╚═══════════════════════════════════════════════════════════════════╝
#
# Usage:
# curl -sL https://raw.githubusercontent.com/khodeordak/paqctl/main/paqctl.sh | sudo bash
#
...
update_management_script() {
    local update_url="https://raw.githubusercontent.com/khodeordak/paqctl/main/paqctl.sh"
    local tmp_script
...
show_help() {
    ...
    echo ""
    echo -e "${BOLD}Paqet:${NC} https://github.com/khodeordak/paqctl"
    echo ""
}
...
show_version() {
    ...
    echo ""
    echo -e "  ${DIM}paqctl by khodeordak: https://github.com/khodeordak/paqctl${NC}"
    echo ""
}
    ...
    while true; do
        ...
        case "$i_choice" in
            1)
                ...
                echo -e "  ${DIM}Project: https://github.com/khodeordak/paqctl${NC}"
                echo ""
                read -n 1 -s -r -p "  Press any key..." < /dev/tty || true
                redraw=true
                ;;
            ...
            5)
                ...
                echo -e "  ${BOLD}Repository:${NC} https://github.com/khodeordak/paqctl"
                ...
                echo ""
                echo -e "  ${BOLD}Built by:${NC}   khodeordak"
                echo -e "  ${BOLD}Repository:${NC} https://github.com/khodeordak/paqctl"
                echo -e "  ${BOLD}License:${NC}    AGPL-3.0 - Copyright (C) 2026 SamNet Technologies, LLC"
                echo ""
